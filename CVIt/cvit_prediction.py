...
facedet.load_weights("/kaggle/working/CViT/helpers/blazeface.pth")
facedet.load_anchors("/kaggle/working/CViT/helpers/anchors.npy")
...
tresh=50
sample='/kaggle/working/CViT/sample__prediction_data/'
...
checkpoint = torch.load('/kaggle/working/CViT/weight/weights.pth', map_location=torch.device('cpu'))
