...
dir_path = "/home/deep/anahita/manipulated_sequences/Deepfakes/c23/videos" 
train_path = "preprocessing/deepfake/training_face_"
validation_path = "preprocessing/deepfake/validation_face_"
test_path = "preprocessing/deepfake/test_face_"
    ...
    for item in sorted(os.listdir(dir_path)):
        ...
        if os.path.isdir(meta_full_path):
            ...
            if data != 1:
                ...
                #print(filtered_files.index("aafezqchru.mp4")  )
                #import pudb; pu.db
                for filename in filtered_files:
                    #import pudb; pu.db
                    # check if the file name is found in metadata, and its label
                    #if filename=='aafezqchru.mp4':
                    #    print(filename)
