...
dir_path = "../original_sequences/youtube/c23/videos"
train_path = "../deepfakes_data/training_face_"
validation_path = "../deepfakes_data/validation_face_"
test_path = "../deepfakes_data/test_face_"
  
# load DFDC json
def load_metadata(dir_path):
    metafile = dir_path+'train.json'
